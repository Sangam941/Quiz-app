        ...
        <div className="bg-white rounded-[2rem] shadow-2xl p-10 border border-gray-100">
          <div className="text-center mb-10">
            ...
            <h2 className="text-4xl font-bold tracking-tight text-gray-900 mb-2">
              {isLogin ? 'Welcome back' : 'Join BizQuiz'}
            </h2>
            <p className="text-gray-500 font-medium tracking-tight">
              {isLogin ? 'Choose your path to excellence' : 'The journey of a thousand steps starts here'}
            </p>
          </div>

          {error && (
            <div className="mb-6 p-4 bg-red-50 border border-red-100 rounded-xl text-red-600 text-sm font-bold tracking-tight">
              {error}
            </div>
          )}
          ...
          <form onSubmit={handleAuth} className="space-y-4">
            ...
            <button
              disabled={loading}
              className="w-full py-4 bg-blue-600 text-white font-bold rounded-xl hover:bg-blue-700 transition-all shadow-xl shadow-blue-100 flex items-center justify-center gap-2 group disabled:opacity-50"
            >
              {loading ? (
          ...
          <div className="mt-8 grid grid-cols-1 gap-4">
            <button
              ...
              className="flex items-center justify-center gap-3 px-4 py-4 border border-gray-200 rounded-xl hover:bg-gray-50 transition-all font-bold text-gray-700 underline-offset-4"
            >
